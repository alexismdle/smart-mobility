...
import tempfile
import pandas as pd # Explicitly import pandas for type hints if necessary, though not strictly required by logic here
...
from project.config.settings import APP_SETTINGS # Import APP_SETTINGS
